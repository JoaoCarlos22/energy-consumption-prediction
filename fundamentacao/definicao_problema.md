...
A previsão de demanda energética configura-se como um desafio crítico no gerenciamento de sistemas modernos de distribuição de energia elétrica. A capacidade de antecipar com precisão o consumo futuro de eletricidade em diferentes setores econômicos — residencial, comercial e industrial — permite que concessionárias, distribuidoras e operadores do sistema otimizem processos fundamentais como o despacho eficiente de recursos de geração, o planejamento estratégico de infraestrutura de distribuição, a alocação racional de investimentos em expansão e o desenvolvimento de políticas de resposta à demanda.

A implementação de redes inteligentes (_smart grids_) e a disseminação de medidores inteligentes (_smart meters_) geraram volumes sem precedentes de dados granulares de consumo energético. Conforme apontam estudos recentes, essa disponibilidade de dados habilitou a aplicação de técnicas avançadas de aprendizado de máquina que demonstraram superioridade em relação aos métodos físicos tradicionais, especialmente em termos de velocidade computacional, flexibilidade e capacidade de capturar relacionamentos não-lineares complexos (Wu et al., 2024).

O presente trabalho aborda o desenvolvimento, validação e avaliação sistemática em tarefa de regressão supervisionada para previsão de demanda energética em contexto multissetorial pela ferramenta Weka. A escolha de regressão como tarefa de aprendizado máquina é fundamentada em múltiplos estudos que demonstram sua efetividade em cenários de previsão de consumo, onde o objetivo é estimar valores contínuos de consumo energético futuro. Diferenciando-se de estudos anteriores que tipicamente se concentram em um único tipo de edifício, este trabalho propõe uma abordagem integrada que reconhece e modela explicitamente os padrões de consumo distintos entre os setores residencial, comercial e industrial.
